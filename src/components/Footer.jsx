      ...
      <div className="bg-gray-200 px-6 py-8">
        <div className="max-w-screen-lg mx-auto grid md:grid-cols-2 items-center gap-6">
          <div className="max-w-sm">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">Be the first to know exclusive offers, new services, couriers, tools and more.</p>
          </div>
          ...
          <div className="max-w-md relative flex items-center p-1.5 bg-white border border-gray-300 rounded-md">
            ...
            <button type="button"
              className="px-6 py-3 rounded-sm text-white text-sm font-medium tracking-wider border-0 outline-0 bg-[#348763] hover:[bg-purple-700] active:bg-[black] cursor-pointer">Subscribe</button>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="max-w-sm">
              <a href='javascript:void(0)'>
                <img src="/assests/images/Blogo.png" alt="logo" className="w-36" />
              </a>
              <div className="mt-4">
                <p className="text-slate-900 leading-relaxed text-sm">Car rental services provide customers with the convenience of hiring vehicles for short or long durations without owning them. Tailwind CSS.</p>
              </div>

              <div className="mt-6">
                <h4 className="text-black text-base font-semibold mb-4">Trustpilot</h4>
                <div className="flex space-x-3 mt-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-[#F7D720]" viewBox="0 0 24 24">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-[#CED5D8]" viewBox="0 0 24 24">
                    <path d="m23.363 8.584-7.378-1.127L12.678.413c-.247-.526-1.11-.526-1.357 0L8.015 7.457.637 8.584a.75.75 0 0 0-.423 1.265l5.36 5.494-1.267 7.767a.75.75 0 0 0 1.103.777L12 20.245l6.59 3.643a.75.75 0 0 0 1.103-.777l-1.267-7.767 5.36-5.494a.75.75 0 0 0-.423-1.266z" data-original="#ffc107" />
                  </svg>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 grid grid-cols-2 md:grid-cols-3 gap-6">
              <div>
                <h6 className="text-slate-900 text-base font-semibold mb-4">Learning</h6>
                <ul className="space-y-2">
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Education Programs</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Devices for Schools</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Teams for Education</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Microsoft 365</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">School Purchases</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Teacher Training</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Student Deals</a></li>
                </ul>
              </div>

              <div>
                <h6 className="text-slate-900 text-base font-semibold mb-4">Developer Resources</h6>
                <ul className="space-y-2">
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Azure Services</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Developer Hub</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Documentation</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Learning Resources</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Tech Community</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Azure Marketplace</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">AppSource</a></li>
                </ul>
              </div>

              <div>
                <h6 className="text-slate-900 text-base font-semibold mb-4">About Us</h6>
                <ul className="space-y-2">
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Career Opportunities</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Our Story</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Company News</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Privacy Policy</a></li>
                  <li><a href="javascript:void(0)" className="text-slate-900 text-sm hover:underline">Investor Relations</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className='grid lg:grid-cols-4 md:grid-cols-2 gap-6'>
            <div className='flex items-center gap-6'>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0 fill-[#348763]" viewBox="0 0 512 512">
              ...
              <div>
                <h6 className="text-[#348763] text-base font-semibold">Free Shipping</h6>
                <p className='text-slate-900 text-sm mt-1'>On Orders Above ₹499</p>
              </div>
            </div>
            <div className='flex items-center gap-6'>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0 fill-[#348763] stroke-[#348763]" viewBox="0 0 682.667 682.667">
                <defs>
                  <clipPath id="a" clipPathUnits="userSpaceOnUse">
                    <path d="M0 512h512V0H0Z" data-original="#000000" />
                  </clipPath>
                </defs>
                <g fill="none" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="40" clipPath="url(#a)" transform="matrix(1.33333 0 0 -1.33333 0 682.667)">
              ...
              <div>
                <h6 className="text-[#348763] text-base font-semibold">100% Secure</h6>
            ...
            <div className='flex items-center gap-6'>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0 fill-[#348763] stroke-[#348763]" viewBox="0 0 682.667 682.667">
                ...
                <g fill="none" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="30" clipPath="url(#a)" transform="matrix(1.33333 0 0 -1.33333 0 682.667)">
              ...
              <div>
                <h6 className="text-[#348763] text-base font-semibold">Outstanding</h6>
                <p className='text-slate-900 text-sm mt-1'>Wordwide support</p>
              </div>
            </div>
            <div className='flex items-center gap-6'>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 shrink-0 fill-[#348763]" viewBox="0 0 511.987 511">
              ...
              <div>
                <h6 className="text-[#348763] text-base font-semibold">Over 1,000</h6>
          ...
          <div className="flex items-center justify-between flex-wrap gap-6">
            <p className="text-slate-900 text-sm">© All rights reserved.</p>
